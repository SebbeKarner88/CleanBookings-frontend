...
const schema = z.object({
    ...
    postalCode: z
        ...
        .min(5, {message: "Postal code must be minimum of 5 numbers."})
        .max(5, {message: "Postal code must be maximum of 5 numbers (with no white spaces)."}),
    city: z
        .string()
...
export function FormRegister() {
    ...
    return (
                <form className="my-3 my-lg-5 mx-lg-5 text-start"
                    ...
                    <h2 className="my-3">New customer</h2>
                    <FormField
                        fieldName="firstName"
                        label="First name"
                        inputType="text"
